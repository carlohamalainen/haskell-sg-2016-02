...
\begin{frame}
\frametitle{DL.length}
\centering
\includegraphics[width=90mm]{dl-dot-length.png}
\end{frame}

\begin{frame}
\frametitle{Just}
\centering
\includegraphics[width=90mm]{just.png}
\end{frame}

\begin{frame}
\frametitle{Safe}
\centering
\includegraphics[width=90mm]{safe.png}
\end{frame}

\begin{frame}
\frametitle{TP.upper}
\centering
\includegraphics[width=90mm]{tp-upper.png}
\end{frame}
